...
import digital.forge.data.models
from digital.forge.data import rest
from digital.forge.data.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(digital.forge.data.models, klass)
